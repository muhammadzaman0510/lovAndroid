...
import app.lov.com.lov_android_app.MyApp;
import app.lov.com.lov_android_app.R;

/**
 * Created by macbookpro on 07.03.2017.
 */
...
public class Shop {
    ...
    private Shop() {
        storage = MyApp.getInstance().getSharedPreferences(STORAGE, Context.MODE_PRIVATE);
    }
